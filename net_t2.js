...
const r_11_256_32_4_8_16_3_4_3_3 = `enable f16;
...
@compute @workgroup_size(8,16) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  var alu27 = (1.0f-exp2((alu22*1.4426950408889634f)));
  var alu28 = (1.0f-exp2((alu23*1.4426950408889634f)));
  var alu29 = (1.0f-exp2((alu24*1.4426950408889634f)));
  var alu30 = (1.0f-exp2((alu25*1.4426950408889634f)));
  data0[alu26] = (select(0.0f,alu22,(0.0f<alu22))-select(0.0f,alu27,(0.0f<alu27)));
  data0[(alu26+1)] = (select(0.0f,alu23,(0.0f<alu23))-select(0.0f,alu28,(0.0f<alu28)));
  data0[(alu26+2)] = (select(0.0f,alu24,(0.0f<alu24))-select(0.0f,alu29,(0.0f<alu29)));
  data0[(alu26+3)] = (select(0.0f,alu25,(0.0f<alu25))-select(0.0f,alu30,(0.0f<alu30)));
}`;

const r_2_2 = `enable f16;
fn nan() -> f32 { let bits = 0xffffffffu; return bitcast<f32>(bits); }
fn is_nan(v:f32) -> bool { return min(v, 1.0) == 1.0 && max(v, -1.0) == -1.0; }
@group(0) @binding(0)
var<uniform> INFINITY : f32;
...
const r_11_256_32_4_8_16_11_3_4_3_3 = `enable f16;
fn nan() -> f32 { let bits = 0xffffffffu; return bitcast<f32>(bits); }
fn is_nan(v:f32) -> bool { return min(v, 1.0) == 1.0 && max(v, -1.0) == -1.0; }
@group(0) @binding(0)
var<uniform> INFINITY : f32;
...
@compute @workgroup_size(8,16) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  var acc2 = 0.0f;
  var acc3 = 0.0f;
  for (var ridx0 = 0; ridx0 < 11; ridx0++) {
    for (var ridx1 = 0; ridx1 < 3; ridx1++) {
      ...
      var alu17 = ((gidx2*297)+(ridx0*27)+(ridx1*9));
  ...
  var alu30 = (1.0f-exp2((alu25*1.4426950408889634f)));
  var alu31 = (1.0f-exp2((alu26*1.4426950408889634f)));
  var alu32 = (1.0f-exp2((alu27*1.4426950408889634f)));
  var alu33 = (1.0f-exp2((alu28*1.4426950408889634f)));
  data0[alu29] = (select(0.0f,alu25,(0.0f<alu25))-select(0.0f,alu30,(0.0f<alu30)));
  data0[(alu29+1)] = (select(0.0f,alu26,(0.0f<alu26))-select(0.0f,alu31,(0.0f<alu31)));
  data0[(alu29+2)] = (select(0.0f,alu27,(0.0f<alu27))-select(0.0f,alu32,(0.0f<alu32)));
  data0[(alu29+3)] = (select(0.0f,alu28,(0.0f<alu28))-select(0.0f,alu33,(0.0f<alu33)));
}`;

const r_11_256_32_4_8_16_11_3_4_3_3n1 = `enable f16;
fn nan() -> f32 { let bits = 0xffffffffu; return bitcast<f32>(bits); }
fn is_nan(v:f32) -> bool { return min(v, 1.0) == 1.0 && max(v, -1.0) == -1.0; }
@group(0) @binding(0)
var<uniform> INFINITY : f32;
...
@compute @workgroup_size(8,16) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  for (var ridx0 = 0; ridx0 < 11; ridx0++) {
    for (var ridx1 = 0; ridx1 < 3; ridx1++) {
      ...
      var alu21 = ((gidx2*297)+(ridx0*27)+(ridx1*9));
  ...
  var alu34 = (1.0f-exp2((alu29*1.4426950408889634f)));
  var alu35 = (1.0f-exp2((alu30*1.4426950408889634f)));
  var alu36 = (1.0f-exp2((alu31*1.4426950408889634f)));
  var alu37 = (1.0f-exp2((alu32*1.4426950408889634f)));
  data0[alu33] = (select(0.0f,alu29,(0.0f<alu29))-select(0.0f,alu34,(0.0f<alu34)));
  data0[(alu33+1)] = (select(0.0f,alu30,(0.0f<alu30))-select(0.0f,alu35,(0.0f<alu35)));
  data0[(alu33+2)] = (select(0.0f,alu31,(0.0f<alu31))-select(0.0f,alu36,(0.0f<alu36)));
  data0[(alu33+3)] = (select(0.0f,alu32,(0.0f<alu32))-select(0.0f,alu37,(0.0f<alu37)));
}`;

const r_11_256_32_4_8_16_11_3_4_3_3n2 = `enable f16;
fn nan() -> f32 { let bits = 0xffffffffu; return bitcast<f32>(bits); }
fn is_nan(v:f32) -> bool { return min(v, 1.0) == 1.0 && max(v, -1.0) == -1.0; }
@group(0) @binding(0)
var<uniform> INFINITY : f32;
...
@compute @workgroup_size(8,16) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  for (var ridx0 = 0; ridx0 < 11; ridx0++) {
    for (var ridx1 = 0; ridx1 < 3; ridx1++) {
      ...
      var alu19 = ((gidx2*297)+(ridx0*27)+(ridx1*9));
  ...
  var alu34 = (1.0f-exp2((alu29*1.4426950408889634f)));
  var alu35 = (1.0f-exp2((alu30*1.4426950408889634f)));
  data0[alu31] = (select(0.0f,alu27,(0.0f<alu27))-select(0.0f,alu32,(0.0f<alu32)));
  data0[(alu31+1)] = (select(0.0f,alu28,(0.0f<alu28))-select(0.0f,alu33,(0.0f<alu33)));
  data0[(alu31+2)] = (select(0.0f,alu29,(0.0f<alu29))-select(0.0f,alu34,(0.0f<alu34)));
  data0[(alu31+3)] = (select(0.0f,alu30,(0.0f<alu30))-select(0.0f,alu35,(0.0f<alu35)));
}`;

const r_11_256_32_4_8_16_11_3_4_3_3n3 = `enable f16;
fn nan() -> f32 { let bits = 0xffffffffu; return bitcast<f32>(bits); }
fn is_nan(v:f32) -> bool { return min(v, 1.0) == 1.0 && max(v, -1.0) == -1.0; }
@group(0) @binding(0)
var<uniform> INFINITY : f32;
...
const r_11_256_32_4_8_16_11_3_4_3_3n4 = `enable f16;
fn nan() -> f32 { let bits = 0xffffffffu; return bitcast<f32>(bits); }
fn is_nan(v:f32) -> bool { return min(v, 1.0) == 1.0 && max(v, -1.0) == -1.0; }
@group(0) @binding(0)
var<uniform> INFINITY : f32;
...
@compute @workgroup_size(8,16) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  for (var ridx0 = 0; ridx0 < 11; ridx0++) {
    for (var ridx1 = 0; ridx1 < 3; ridx1++) {
      ...
      var alu15 = ((gidx2*297)+(ridx0*27)+(ridx1*9));
  ...
  var alu30 = (1.0f-exp2((alu25*1.4426950408889634f)));
  var alu31 = (1.0f-exp2((alu26*1.4426950408889634f)));
  data0[alu27] = (select(0.0f,alu23,(0.0f<alu23))-select(0.0f,alu28,(0.0f<alu28)));
  data0[(alu27+1)] = (select(0.0f,alu24,(0.0f<alu24))-select(0.0f,alu29,(0.0f<alu29)));
  data0[(alu27+2)] = (select(0.0f,alu25,(0.0f<alu25))-select(0.0f,alu30,(0.0f<alu30)));
  data0[(alu27+3)] = (select(0.0f,alu26,(0.0f<alu26))-select(0.0f,alu31,(0.0f<alu31)));
}`;

const r_32768_8_1_2_16_4_11 = `enable f16;
fn nan() -> f32 { let bits = 0xffffffffu; return bitcast<f32>(bits); }
fn is_nan(v:f32) -> bool { return min(v, 1.0) == 1.0 && max(v, -1.0) == -1.0; }
@group(0) @binding(0)
var<uniform> INFINITY : f32;
...
@compute @workgroup_size(2,16) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  var val10 = data2[(alu0+9)];
  var val11 = data2[(alu0+10)];
  var alu1 = ((gidx1<<6)+(gidx2<<9));
  var alu2 = (lidx1<<2);
  var alu3 = (alu1+alu2);
  ...
  var val16 = data1[(alu3+16777216)];
  var val17 = data1[(alu3+16777217)];
  var val18 = data1[(alu3+16777218)];
  var val19 = data1[(alu3+16777219)];
  var val20 = data1[(alu3+33554432)];
  var val21 = data1[(alu3+33554433)];
  var val22 = data1[(alu3+33554434)];
  var val23 = data1[(alu3+33554435)];
  var val24 = data1[(alu3+50331648)];
  var val25 = data1[(alu3+50331649)];
  var val26 = data1[(alu3+50331650)];
  var val27 = data1[(alu3+50331651)];
  var val28 = data1[(alu3+67108864)];
  var val29 = data1[(alu3+67108865)];
  var val30 = data1[(alu3+67108866)];
  var val31 = data1[(alu3+67108867)];
  var val32 = data1[(alu3+83886080)];
  var val33 = data1[(alu3+83886081)];
  var val34 = data1[(alu3+83886082)];
  var val35 = data1[(alu3+83886083)];
  var val36 = data1[(alu3+100663296)];
  var val37 = data1[(alu3+100663297)];
  var val38 = data1[(alu3+100663298)];
  var val39 = data1[(alu3+100663299)];
  var val40 = data1[(alu3+117440512)];
  var val41 = data1[(alu3+117440513)];
  var val42 = data1[(alu3+117440514)];
  var val43 = data1[(alu3+117440515)];
  var val44 = data1[(alu3+134217728)];
  var val45 = data1[(alu3+134217729)];
  var val46 = data1[(alu3+134217730)];
  var val47 = data1[(alu3+134217731)];
  var val48 = data1[(alu3+150994944)];
  var val49 = data1[(alu3+150994945)];
  var val50 = data1[(alu3+150994946)];
  var val51 = data1[(alu3+150994947)];
  var val52 = data1[(alu3+167772160)];
  var val53 = data1[(alu3+167772161)];
  var val54 = data1[(alu3+167772162)];
  var val55 = data1[(alu3+167772163)];
  var alu4 = (alu1+(lidx0<<24)+alu2);
  data0[alu4] = (val0+(val2*val16)+(val1*val12)+(val3*val20)+(val4*val24)+(val5*val28)+(val6*val32)+(val7*val36)+(val8*val40)+(val9*val44)+(val10*val48)+(val11*val52));
  data0[(alu4+1)] = (val0+(val2*val17)+(val1*val13)+(val3*val21)+(val4*val25)+(val5*val29)+(val6*val33)+(val7*val37)+(val8*val41)+(val9*val45)+(val10*val49)+(val11*val53));
  data0[(alu4+2)] = (val0+(val2*val18)+(val1*val14)+(val3*val22)+(val4*val26)+(val5*val30)+(val6*val34)+(val7*val38)+(val8*val42)+(val9*val46)+(val10*val50)+(val11*val54));
  data0[(alu4+3)] = (val0+(val2*val19)+(val1*val15)+(val3*val23)+(val4*val27)+(val5*val31)+(val6*val35)+(val7*val39)+(val8*val43)+(val9*val47)+(val10*val51)+(val11*val55));
}`;

const r_32768_16_1_32_2 = `enable f16;
fn nan() -> f32 { let bits = 0xffffffffu; return bitcast<f32>(bits); }
fn is_nan(v:f32) -> bool { return min(v, 1.0) == 1.0 && max(v, -1.0) == -1.0; }
@group(0) @binding(0)
var<uniform> INFINITY : f32;
...
const r_32768_4_1_32_4_2 = `enable f16;
fn nan() -> f32 { let bits = 0xffffffffu; return bitcast<f32>(bits); }
fn is_nan(v:f32) -> bool { return min(v, 1.0) == 1.0 && max(v, -1.0) == -1.0; }
@group(0) @binding(0)
var<uniform> INFINITY : f32;
...
@compute @workgroup_size(32) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  var alu4 = ((i32(((val5!=val4)!=true)))*val0);
  var alu5 = ((i32(((val7!=val6)!=true)))*val0);
  var alu6 = ((i32(((val9!=val8)!=true)))*val0);
  var alu7 = ((i32(((val10!=val3)!=true)))*val1);
  var alu8 = ((i32(((val11!=val4)!=true)))*val1);
  var alu9 = ((i32(((val12!=val6)!=true)))*val1);
  var alu10 = ((i32(((val13!=val8)!=true)))*val1);
  var alu11 = ((i32(((val2!=val3)!=true)))*val0);
  data0[alu1] = (f32((2-select(alu4,alu8,(alu4<alu8)))));
  data0[alu2] = (f32((2-select(alu5,alu9,(alu5<alu9)))));
  data0[alu3] = (f32((2-select(alu6,alu10,(alu6<alu10)))));
  data0[alu0] = (f32((2-select(alu7,alu11,(alu7<alu11)))));
}`;
...
const setupNet = async (device, safetensor) => {
    ...
    const buf_0 = createEmptyBuf(device, 738197504);;
    const input0 = createEmptyBuf(device, 67108864);;
    const buf_1 = createWeightBuf(device, 1188, getTensorBuffer(safetensor, metadata['convs.0.weight']));
    const buf_2 = createWeightBuf(device, 44, getTensorBuffer(safetensor, metadata['convs.0.bias']));
    const buf_3 = createEmptyBuf(device, 8);;
    const buf_4 = createEmptyBuf(device, 738197504);;
    const buf_5 = createWeightBuf(device, 13068, getTensorBuffer(safetensor, metadata['convs.1.weight']));
    const buf_6 = createWeightBuf(device, 44, getTensorBuffer(safetensor, metadata['convs.1.bias']));
    const buf_7 = createWeightBuf(device, 13068, getTensorBuffer(safetensor, metadata['convs.2.weight']));
    const buf_8 = createWeightBuf(device, 44, getTensorBuffer(safetensor, metadata['convs.2.bias']));
    const buf_9 = createWeightBuf(device, 13068, getTensorBuffer(safetensor, metadata['convs.3.weight']));
    const buf_10 = createWeightBuf(device, 44, getTensorBuffer(safetensor, metadata['convs.3.bias']));
    const buf_11 = createWeightBuf(device, 13068, getTensorBuffer(safetensor, metadata['convs.4.weight']));
    const buf_12 = createWeightBuf(device, 44, getTensorBuffer(safetensor, metadata['convs.4.bias']));
    const buf_13 = createWeightBuf(device, 13068, getTensorBuffer(safetensor, metadata['convs.5.weight']));
    const buf_14 = createWeightBuf(device, 44, getTensorBuffer(safetensor, metadata['convs.5.bias']));
    const buf_15 = createWeightBuf(device, 13068, getTensorBuffer(safetensor, metadata['convs.6.weight']));
    const buf_16 = createWeightBuf(device, 44, getTensorBuffer(safetensor, metadata['convs.6.bias']));
    const buf_17 = createWeightBuf(device, 13068, getTensorBuffer(safetensor, metadata['convs.7.weight']));
    const buf_18 = createWeightBuf(device, 44, getTensorBuffer(safetensor, metadata['convs.7.bias']));
    const buf_19 = createWeightBuf(device, 13068, getTensorBuffer(safetensor, metadata['convs.8.weight']));
    const buf_20 = createWeightBuf(device, 44, getTensorBuffer(safetensor, metadata['convs.8.bias']));
    const buf_21 = createEmptyBuf(device, 134217728);;
    const buf_22 = createWeightBuf(device, 88, getTensorBuffer(safetensor, metadata['convs.9.weight']));
    const buf_23 = createWeightBuf(device, 8, getTensorBuffer(safetensor, metadata['convs.9.bias']));
    ...
    const kernels = [r_11_256_32_4_8_16_3_4_3_3, r_2_2, r_11_256_32_4_8_16_11_3_4_3_3, r_11_256_32_4_8_16_11_3_4_3_3n1, r_11_256_32_4_8_16_11_3_4_3_3n2, r_11_256_32_4_8_16_11_3_4_3_3n3, r_11_256_32_4_8_16_11_3_4_3_3n2, r_11_256_32_4_8_16_11_3_4_3_3n1, r_11_256_32_4_8_16_11_3_4_3_3, r_11_256_32_4_8_16_11_3_4_3_3n4, r_32768_8_1_2_16_4_11, r_32768_16_1_32_2, r_32768_4_1_32_4_2];
    ...
    return async (_input0) => {
        ...
        addComputePass(device, commandEncoder, pipelines[0], layouts[0], infinityBuf, [buf_0, input0, buf_1, buf_2], [128, 256, 11]);
        addComputePass(device, commandEncoder, pipelines[1], layouts[1], infinityBuf, [buf_3], [1, 1, 1]);
        addComputePass(device, commandEncoder, pipelines[2], layouts[2], infinityBuf, [buf_4, buf_0, buf_5, buf_6], [128, 256, 11]);
        addComputePass(device, commandEncoder, pipelines[3], layouts[3], infinityBuf, [buf_0, buf_4, buf_7, buf_8], [128, 256, 11]);
        addComputePass(device, commandEncoder, pipelines[4], layouts[4], infinityBuf, [buf_4, buf_0, buf_9, buf_10], [128, 256, 11]);
        addComputePass(device, commandEncoder, pipelines[5], layouts[5], infinityBuf, [buf_0, buf_4, buf_11, buf_12], [128, 256, 11]);
        addComputePass(device, commandEncoder, pipelines[6], layouts[6], infinityBuf, [buf_4, buf_0, buf_13, buf_14], [128, 256, 11]);
        addComputePass(device, commandEncoder, pipelines[7], layouts[7], infinityBuf, [buf_0, buf_4, buf_15, buf_16], [128, 256, 11]);
        addComputePass(device, commandEncoder, pipelines[8], layouts[8], infinityBuf, [buf_4, buf_0, buf_17, buf_18], [128, 256, 11]);
        addComputePass(device, commandEncoder, pipelines[9], layouts[9], infinityBuf, [buf_0, buf_4, buf_19, buf_20], [128, 256, 11]);
        addComputePass(device, commandEncoder, pipelines[10], layouts[10], infinityBuf, [buf_21, buf_0, buf_22, buf_23], [1, 8, 32768]);
