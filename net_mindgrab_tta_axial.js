...
const r_5_256_32_4_8_16_4_3_3_3_3n2 = `fn nan() -> f32 { let bits = 0xffffffffu; return bitcast<f32>(bits); }
@group(0) @binding(0)
var<uniform> INFINITY : f32;
@group(0) @binding(1)var<storage,read_write>data0_251658240:array<f32>;
@group(0) @binding(2)var<storage,read_write>data1_16777216:array<f32>;
...
@compute @workgroup_size(8,16) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  ...
  var cast5 = bitcast<u32>((gidx0&3));
  var alu0 = (lidx1+bitcast<i32>((cast5<<4u)));
  var alu1 = (bitcast<i32>((cast3<<2u))+bitcast<i32>((cast5<<6u)));
  var alu2 = (bitcast<i32>((cast2<<8u))+bitcast<i32>((cast4<<11u))+alu1);
  var alu3 = (gidx0<120);
  var alu4 = (alu0<60);
  var alu5 = (3<alu0);
  var alu6 = (7<gidx0);
  ...
  for (var Ridx0 = 0; Ridx0 < 3; Ridx0++) {
    var cast6 = bitcast<u32>(Ridx0);
    var alu19 = (lidx0+bitcast<i32>((cast4<<3u))+bitcast<i32>((cast0<<8u))+bitcast<i32>((cast6<<12u)));
    var alu20 = (gidx1+bitcast<i32>((cast6<<4u)));
    var alu21 = (alu1+bitcast<i32>((bitcast<u32>(((alu19+-4112)&65535))<<8u)));
    var alu22 = ((15<alu20)&(alu20<272));
    var alu23 = (alu6&alu22);
    var val0 = select(0.0f, data1_16777216[alu21], alu23);
    var alu24 = (alu5&alu6&alu22);
    var val1 = select(0.0f, data1_16777216[(alu21+-16)], alu24);
    var alu25 = ((gidx2*81)+(Ridx0*9));
    var val2 = data2_405[(alu25+1)];
    var val3 = data2_405[(alu25+2)];
    var val4 = data2_405[(alu25+3)];
    var val5 = data2_405[(alu25+4)];
    var val6 = data2_405[alu25];
    var alu26 = (alu1+bitcast<i32>((bitcast<u32>(((alu19+-4096)&65535))<<8u)));
    var val7 = select(0.0f, data1_16777216[alu26], alu22);
    var alu27 = (alu4&alu6&alu22);
    var val8 = select(0.0f, data1_16777216[(alu21+16)], alu27);
    var alu28 = (alu5&alu22);
    var val9 = select(0.0f, data1_16777216[(alu26+-16)], alu28);
    var alu29 = (alu4&alu22);
    var val10 = select(0.0f, data1_16777216[(alu26+16)], alu29);
    var val11 = data2_405[(alu25+5)];
    var alu30 = (alu1+bitcast<i32>((bitcast<u32>(((alu19+-4080)&65535))<<8u)));
    var alu31 = (alu5&alu3&alu22);
    var val12 = select(0.0f, data1_16777216[(alu30+-16)], alu31);
    var val13 = data2_405[(alu25+6)];
    var alu32 = (alu3&alu22);
    var val14 = select(0.0f, data1_16777216[alu30], alu32);
    var val15 = data2_405[(alu25+7)];
    var alu33 = (alu4&alu3&alu22);
    var val16 = select(0.0f, data1_16777216[(alu30+16)], alu33);
    var val17 = data2_405[(alu25+8)];
    var val18 = data2_405[(alu25+27)];
    var val19 = data2_405[(alu25+28)];
    var val20 = data2_405[(alu25+29)];
    var val21 = data2_405[(alu25+30)];
    var val22 = data2_405[(alu25+31)];
    var val23 = data2_405[(alu25+32)];
    var val24 = data2_405[(alu25+33)];
    var val25 = data2_405[(alu25+34)];
    var val26 = data2_405[(alu25+35)];
    var val27 = data2_405[(alu25+54)];
    var val28 = data2_405[(alu25+55)];
    var val29 = data2_405[(alu25+56)];
    var val30 = data2_405[(alu25+57)];
    var val31 = data2_405[(alu25+58)];
    var val32 = data2_405[(alu25+59)];
    var val33 = data2_405[(alu25+60)];
    var val34 = data2_405[(alu25+61)];
    var val35 = data2_405[(alu25+62)];
    var alu34 = (alu2+cast1+bitcast<i32>((cast6<<20u)));
    var alu35 = (alu34+-1052687);
    var alu36 = select(0,255,(alu35<0));
    var val36 = select(0.0f, data1_16777216[(bitcast<i32>((bitcast<u32>((((alu35+alu36)>>8u)&65535))<<8u))+(alu35&255))], alu24);
    var alu37 = (alu34+-1052655);
    var alu38 = select(0,255,(alu37<0));
    var val37 = select(0.0f, data1_16777216[(bitcast<i32>((bitcast<u32>((((alu37+alu38)>>8u)&65535))<<8u))+(alu37&255))], alu27);
    var alu39 = (alu34+-1048591);
    var alu40 = select(0,255,(alu39<0));
    var val38 = select(0.0f, data1_16777216[(bitcast<i32>((bitcast<u32>((((alu39+alu40)>>8u)&65535))<<8u))+(alu39&255))], alu28);
    var alu41 = (alu34+-1048559);
    var alu42 = select(0,255,(alu41<0));
    var val39 = select(0.0f, data1_16777216[(bitcast<i32>((bitcast<u32>((((alu41+alu42)>>8u)&65535))<<8u))+(alu41&255))], alu29);
    var alu43 = (alu34+-1044495);
    var alu44 = select(0,255,(alu43<0));
    var val40 = select(0.0f, data1_16777216[(bitcast<i32>((bitcast<u32>((((alu43+alu44)>>8u)&65535))<<8u))+(alu43&255))], alu31);
    var alu45 = (alu34+-1044463);
    var alu46 = select(0,255,(alu45<0));
    var val41 = select(0.0f, data1_16777216[(bitcast<i32>((bitcast<u32>((((alu45+alu46)>>8u)&65535))<<8u))+(alu45&255))], alu33);
    var val42 = select(0.0f, data1_16777216[(alu21+1)], alu23);
    var val43 = select(0.0f, data1_16777216[(alu26+1)], alu22);
    var val44 = select(0.0f, data1_16777216[(alu30+1)], alu32);
    var alu47 = (bitcast<i32>((cast2<<7u))+bitcast<i32>((cast4<<10u))+bitcast<i32>((cast3<<1u))+bitcast<i32>((cast5<<5u))+bitcast<i32>((cast0<<15u))+bitcast<i32>((cast6<<19u)));
    var alu48 = (alu47+-526343);
    var alu49 = select(0,127,(alu48<0));
    var val45 = select(0.0f, data1_16777216[(bitcast<i32>((bitcast<u32>((alu48&127))<<1u))+bitcast<i32>((bitcast<u32>((((alu48+alu49)>>7u)&65535))<<8u)))], alu24);
    var alu50 = (alu47+-526327);
    var alu51 = select(0,127,(alu50<0));
    var val46 = select(0.0f, data1_16777216[(bitcast<i32>((bitcast<u32>((alu50&127))<<1u))+bitcast<i32>((bitcast<u32>((((alu50+alu51)>>7u)&65535))<<8u)))], alu27);
    var alu52 = (alu47+-524295);
    var alu53 = select(0,127,(alu52<0));
    var val47 = select(0.0f, data1_16777216[(bitcast<i32>((bitcast<u32>((alu52&127))<<1u))+bitcast<i32>((bitcast<u32>((((alu52+alu53)>>7u)&65535))<<8u)))], alu28);
    var alu54 = (alu47+-524279);
    var alu55 = select(0,127,(alu54<0));
    var val48 = select(0.0f, data1_16777216[(bitcast<i32>((bitcast<u32>((alu54&127))<<1u))+bitcast<i32>((bitcast<u32>((((alu54+alu55)>>7u)&65535))<<8u)))], alu29);
    var alu56 = (alu47+-522247);
    var alu57 = select(0,127,(alu56<0));
    var val49 = select(0.0f, data1_16777216[(bitcast<i32>((bitcast<u32>((alu56&127))<<1u))+bitcast<i32>((bitcast<u32>((((alu56+alu57)>>7u)&65535))<<8u)))], alu31);
    var alu58 = (alu47+-522231);
    var alu59 = select(0,127,(alu58<0));
    var val50 = select(0.0f, data1_16777216[(bitcast<i32>((bitcast<u32>((alu58&127))<<1u))+bitcast<i32>((bitcast<u32>((((alu58+alu59)>>7u)&65535))<<8u)))], alu33);
    var val51 = select(0.0f, data1_16777216[(alu21+2)], alu23);
    var val52 = select(0.0f, data1_16777216[(alu26+2)], alu22);
    var val53 = select(0.0f, data1_16777216[(alu30+2)], alu32);
    var alu60 = (alu34+-1052685);
    var alu61 = select(0,255,(alu60<0));
    var val54 = select(0.0f, data1_16777216[(bitcast<i32>((bitcast<u32>((((alu60+alu61)>>8u)&65535))<<8u))+(alu60&255))], alu24);
    var alu62 = (alu34+-1052653);
    var alu63 = select(0,255,(alu62<0));
    var val55 = select(0.0f, data1_16777216[(bitcast<i32>((bitcast<u32>((((alu62+alu63)>>8u)&65535))<<8u))+(alu62&255))], alu27);
    var alu64 = (alu34+-1048589);
    var alu65 = select(0,255,(alu64<0));
    var val56 = select(0.0f, data1_16777216[(bitcast<i32>((bitcast<u32>((((alu64+alu65)>>8u)&65535))<<8u))+(alu64&255))], alu28);
    var alu66 = (alu34+-1048557);
    var alu67 = select(0,255,(alu66<0));
    var val57 = select(0.0f, data1_16777216[(bitcast<i32>((bitcast<u32>((((alu66+alu67)>>8u)&65535))<<8u))+(alu66&255))], alu29);
    var alu68 = (alu34+-1044493);
    var alu69 = select(0,255,(alu68<0));
    var val58 = select(0.0f, data1_16777216[(bitcast<i32>((bitcast<u32>((((alu68+alu69)>>8u)&65535))<<8u))+(alu68&255))], alu31);
    var alu70 = (alu34+-1044461);
    var alu71 = select(0,255,(alu70<0));
    var val59 = select(0.0f, data1_16777216[(bitcast<i32>((bitcast<u32>((((alu70+alu71)>>8u)&65535))<<8u))+(alu70&255))], alu33);
    var val60 = select(0.0f, data1_16777216[(alu21+3)], alu23);
    var val61 = select(0.0f, data1_16777216[(alu26+3)], alu22);
    var val62 = select(0.0f, data1_16777216[(alu30+3)], alu32);
    acc0[0] = (acc0[0]+(val1*val6)+(val0*val2)+(val8*val3)+(val9*val4)+(val7*val5)+(val10*val11)+(val12*val13)+(val14*val15)+(val16*val17));
    acc0[1] = (acc0[1]+(val1*val18)+(val0*val19)+(val8*val20)+(val9*val21)+(val7*val22)+(val10*val23)+(val12*val24)+(val14*val25)+(val16*val26));
    acc0[2] = (acc0[2]+(val1*val27)+(val0*val28)+(val8*val29)+(val9*val30)+(val7*val31)+(val10*val32)+(val12*val33)+(val14*val34)+(val16*val35));
    acc0[3] = (acc0[3]+(val36*val6)+(val42*val2)+(val37*val3)+(val38*val4)+(val43*val5)+(val39*val11)+(val40*val13)+(val44*val15)+(val41*val17));
    acc0[4] = (acc0[4]+(val36*val18)+(val42*val19)+(val37*val20)+(val38*val21)+(val43*val22)+(val39*val23)+(val40*val24)+(val44*val25)+(val41*val26));
    acc0[5] = (acc0[5]+(val36*val27)+(val42*val28)+(val37*val29)+(val38*val30)+(val43*val31)+(val39*val32)+(val40*val33)+(val44*val34)+(val41*val35));
    acc0[6] = (acc0[6]+(val45*val6)+(val51*val2)+(val46*val3)+(val47*val4)+(val52*val5)+(val48*val11)+(val49*val13)+(val53*val15)+(val50*val17));
    acc0[7] = (acc0[7]+(val45*val18)+(val51*val19)+(val46*val20)+(val47*val21)+(val52*val22)+(val48*val23)+(val49*val24)+(val53*val25)+(val50*val26));
    acc0[8] = (acc0[8]+(val45*val27)+(val51*val28)+(val46*val29)+(val47*val30)+(val52*val31)+(val48*val32)+(val49*val33)+(val53*val34)+(val50*val35));
    acc0[9] = (acc0[9]+(val54*val6)+(val60*val2)+(val55*val3)+(val56*val4)+(val61*val5)+(val57*val11)+(val58*val13)+(val62*val15)+(val59*val17));
    acc0[10] = (acc0[10]+(val54*val18)+(val60*val19)+(val55*val20)+(val56*val21)+(val61*val22)+(val57*val23)+(val58*val24)+(val62*val25)+(val59*val26));
    acc0[11] = (acc0[11]+(val54*val27)+(val60*val28)+(val55*val29)+(val56*val30)+(val61*val31)+(val57*val32)+(val58*val33)+(val62*val34)+(val59*val35));
  }
  var alu85 = (alu2+cast1+(gidx2*50331648));
  data0_251658240[alu85] = acc0[0];
  data0_251658240[(alu85+1)] = acc0[3];
  data0_251658240[(alu85+2)] = acc0[6];
  data0_251658240[(alu85+3)] = acc0[9];
  data0_251658240[(alu85+16777216)] = acc0[1];
  data0_251658240[(alu85+16777217)] = acc0[4];
  data0_251658240[(alu85+16777218)] = acc0[7];
  data0_251658240[(alu85+16777219)] = acc0[10];
  data0_251658240[(alu85+33554432)] = acc0[2];
  data0_251658240[(alu85+33554433)] = acc0[5];
  data0_251658240[(alu85+33554434)] = acc0[8];
  data0_251658240[(alu85+33554435)] = acc0[11];
}`;
...
const r_2_2048_4_8_16_4_4_15_64_4 = `fn nan() -> f32 { let bits = 0xffffffffu; return bitcast<f32>(bits); }
@group(0) @binding(0)
var<uniform> INFINITY : f32;
@group(0) @binding(1)var<storage,read_write>data0_33554432:array<f32>;
@group(0) @binding(2)var<storage,read_write>data1_251658240:array<f32>;
...
@group(0) @binding(7)var<storage,read_write>data6_33554432:array<f32>;
@compute @workgroup_size(8,16) fn main(@builtin(workgroup_id) gindex: vec3<u32>,@builtin(local_invocation_id) lindex: vec3<u32>) {
  var acc0: array<f32,16>;
  ...
  for (var Ridx0 = 0; Ridx0 < 15; Ridx0++) {
    ...
    var val5 = data1_251658240[(alu18+512)];
    var val6 = data1_251658240[(alu18+768)];
    var val7 = data1_251658240[(alu18+1)];
    var val8 = data1_251658240[(alu18+257)];
    var val9 = data1_251658240[(alu18+513)];
    var val10 = data1_251658240[(alu18+2)];
    var val11 = data1_251658240[(alu18+769)];
  ...
  for (var Ridx1 = 0; Ridx1 < 64; Ridx1++) {
    ...
    var alu68 = (bitcast<i32>((cast0<<14u))+bitcast<i32>((cast1<<10u))+cast3);
    var val19 = data5_65536[alu68];
    var alu69 = (alu0+cast3+cast2);
    var val20 = data6_33554432[alu69];
    var val21 = data5_65536[(alu68+1)];
    var val22 = data6_33554432[(alu69+1)];
    var val23 = data5_65536[(alu68+2)];
    var val24 = data6_33554432[(alu69+2)];
    var val25 = data5_65536[(alu68+3)];
    var val26 = data6_33554432[(alu69+3)];
    var val27 = data6_33554432[(alu69+256)];
    var val28 = data6_33554432[(alu69+257)];
    var val29 = data6_33554432[(alu69+258)];
    var val30 = data6_33554432[(alu69+259)];
    var val31 = data6_33554432[(alu69+512)];
    var val32 = data6_33554432[(alu69+513)];
    var val33 = data6_33554432[(alu69+514)];
    var val34 = data6_33554432[(alu69+515)];
    var val35 = data6_33554432[(alu69+768)];
    var val36 = data6_33554432[(alu69+769)];
    var val37 = data6_33554432[(alu69+770)];
    var val38 = data6_33554432[(alu69+771)];
    var val39 = data5_65536[(alu68+256)];
    var val40 = data5_65536[(alu68+257)];
    var val41 = data5_65536[(alu68+258)];
    var val42 = data5_65536[(alu68+259)];
    var val43 = data5_65536[(alu68+512)];
    var val44 = data5_65536[(alu68+513)];
    var val45 = data5_65536[(alu68+514)];
    var val46 = data5_65536[(alu68+515)];
    var val47 = data5_65536[(alu68+768)];
    var val48 = data5_65536[(alu68+769)];
    var val49 = data5_65536[(alu68+770)];
    var val50 = data5_65536[(alu68+771)];
    acc0[0] = (acc0[0]+(val19*val20)+(val21*val22)+(val23*val24)+(val25*val26));
    acc0[1] = (acc0[1]+(val19*val27)+(val21*val28)+(val23*val29)+(val25*val30));
    acc0[2] = (acc0[2]+(val19*val31)+(val21*val32)+(val23*val33)+(val25*val34));
    acc0[3] = (acc0[3]+(val19*val35)+(val21*val36)+(val23*val37)+(val25*val38));
    acc0[4] = (acc0[4]+(val39*val20)+(val40*val22)+(val41*val24)+(val42*val26));
    acc0[5] = (acc0[5]+(val39*val27)+(val40*val28)+(val41*val29)+(val42*val30));
    acc0[6] = (acc0[6]+(val39*val31)+(val40*val32)+(val41*val33)+(val42*val34));
    acc0[7] = (acc0[7]+(val39*val35)+(val40*val36)+(val41*val37)+(val42*val38));
    acc0[8] = (acc0[8]+(val43*val20)+(val44*val22)+(val45*val24)+(val46*val26));
    acc0[9] = (acc0[9]+(val43*val27)+(val44*val28)+(val45*val29)+(val46*val30));
    acc0[10] = (acc0[10]+(val43*val31)+(val44*val32)+(val45*val33)+(val46*val34));
    acc0[11] = (acc0[11]+(val43*val35)+(val44*val36)+(val45*val37)+(val46*val38));
    acc0[12] = (acc0[12]+(val47*val20)+(val48*val22)+(val49*val24)+(val50*val26));
    acc0[13] = (acc0[13]+(val47*val27)+(val48*val28)+(val49*val29)+(val50*val30));
    acc0[14] = (acc0[14]+(val47*val31)+(val48*val32)+(val49*val33)+(val50*val34));
    acc0[15] = (acc0[15]+(val47*val35)+(val48*val36)+(val49*val37)+(val50*val38));
  }
  var alu87 = (alu1+cast2);
...
const setupNet = async (device, safetensor) => {
    ...
    return async (_input0) => {
        ...
        addComputePass(device, commandEncoder, pipelines[1], layouts[1], infinityBuf, [buf_2, buf_3, input0], [4, 2048, 1]);
        ...
        addComputePass(device, commandEncoder, pipelines[352], layouts[352], infinityBuf, [buf_38, buf_0, buf_7, buf_9, buf_37, buf_3, buf_36], [4, 2048, 2]);
...
export default mindgrab_tta_axial;
